...
> **언어 능력이 아니라 "나에게 얼마인가"만 보여줍니다.**
>
> 완전히 숨기면 발신자는 자기 메시지가 원문으로 갈지 AI로 갈지 **보내기 전에 모르고**,
> 비용이 사후 확정되어 예산 계획이 불가능해집니다. 그래서 공개는 필요합니다.
>
> 다만 *"B2는 ja를 안다"* 라고 알려주면 **"누구에게 말할지"의 정답을 반쯤 주는 것**이
> 됩니다. 비용표로 보여주면:
>
> - 예산 계획은 완벽하게 가능합니다 (원래 목적 달성)
> - *"왜 B2만 1인가"* 는 **스스로 추론해야** 알 수 있습니다
> - **자기와 관련된 만큼만 드러납니다.** B2가 어떤 언어들을 아는지는 여전히 모르고,
>   "나에게는 싸다"만 압니다
> - 비용은 원칙 3이 명시적으로 허용한 정보 유형입니다
>
> **관측 시 주의:** 값싼 상대에게 말이 몰리는 것은 **경제적 귀결이지 창발이 아닙니다.**
> 결과를 쓸 때 "학습자 허브 현상이 창발했다"고 주장하지 마세요.
> 창발인 것은 **애초에 누가 배우는가**, 그리고 **그 허브 구조가 조율 결과를 바꾸는가**입니다.
...
| 국제 · 모름 | 번역 경유 | `[AI 번역]` | **발생** | `comm_intl_ai` ← **노브** |
